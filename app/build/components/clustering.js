...
var Clustering = React.createClass({displayName: "Clustering",
        ...
        if (this.props.terms && this.props.comments) {
            ...
            list = clusters.map(function(cluster, i) {
                var comments = cluster.map(function(comment_vector) {
                    return React.createElement("li", null, comment_vector.comment.text);
                });
                return React.createElement("div", null, 
                        React.createElement("h2", null, i), 
                        React.createElement("ul", null, comments)
                    );
            });
        }
        return React.createElement("div", {id: "clustering"}, list);
    }
